...
<html lang="en">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item fw-bold" href="#">REGISTRARSE</a></li>
            </ul>
          </li>
        </ul>
 ...
 <!--FORMULARIO REGISTRO-->
  <section class="w-100">
    ...
    <img src="../images/fondoregistro.jpg" class="container-fluid">
    
    <div class="card-img-overlay p-4">
        <form class="mx-auto w-50 p-3 row g-3 needs-validation shadow p-3 mb-5 mt-4 bg-body-tertiary rounded" action="../registro.php" method="post" style="background-color: rgb(222, 221, 221);">
            <div class="col-md-4 position-relative">
                <label for="validationTooltip01" class="form-label text-dark fw-bold text-bg-danger p-2 shadow bg-body-danger rounded">NOMBRE</label>
                <input type="text" class="form-control text-bg-dark text-ligth" name="nombre" id="validationTooltip01" required>
            </div>
            <div class="col-md-4 position-relative">
                <label for="validationTooltip02" class="form-label text-dark fw-bold text-bg-danger p-2 shadow bg-body-danger rounded">APELLIDO/S</label>
                <input type="text" class="form-control text-bg-dark text-ligth" name="apellidos" id="validationTooltip02" required>
            </div>
            <div class="col-md-4 position-relative">
            <label for="validationTooltipUsername" class="form-label text-dark fw-bold text-bg-danger p-2 shadow bg-body-danger rounded">NOMBRE DE USUARIO</label>
            <div class="input-group has-validation">
                <span class="input-group-text" id="validationTooltipUsernamePrepend">@</span>
                <input type="email" class="form-control text-bg-dark text-ligth" name="email" id="validationTooltipUsername" aria-describedby="validationTooltipUsernamePrepend" required>
            </div>
            </div>
            <div class="col-md-6 position-relative">
                <label for="validationTooltip03" class="form-label text-dark fw-bold text-bg-danger p-2 shadow bg-body-danger rounded">CIUDAD</label>
                <input type="text" class="form-control text-bg-dark text-ligth" name="ciudad" id="validationTooltip03" required>
            </div>
            <div class="col-md-3 position-relative">
                <label for="validationTooltip04" class="form-label text-dark fw-bold text-bg-danger p-2 shadow bg-body-danger rounded">CONTRASEÑA</label>
                <input type="text" class="form-control text-bg-dark text-ligth" name="contrasenya" id="validationTooltip04" required>
            </div>
            <div class="col-md-3 position-relative">
                <label for="validationTooltip05" class="form-label text-dark fw-bold text-bg-danger p-2 shadow bg-body-danger rounded">CÓD. POSTAL</label>
                <input type="int" class="form-control text-bg-dark text-ligth" name="cod_post" id="validationTooltip05" required>
            </div>
            <div class="col-12">
           <!-- Button trigger modal -->
                ...
                <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                        <h1 class="modal-title fs-5 text-dark" id="staticBackdropLabel">¿HA COMPLETADO TODOS LOS RECUADROS?</h1>
                        <button type="submit" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body text-dark">
                        En caso de haberlos completado todos, pulse enviar y se creará su usuario, en otro caso, cierre este cuadro.
                        </div>
                        <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">CERRAR</button>
                        <button type="submit" type="button" id="nuevoUser" name="nuevoUser" class="btn btn-danger" data-bs-dismiss="modal">ENVIAR</button>
                        </div>
                    </div>
                    </div>
                </div>
