...
<html lang="en">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link fw-bold" href="#">EQUIPOS</a>
          </li>
          <li class="nav-item">
  ...
  <!--EQUIPOS-->
  <section class="container fluid" id="equipos">
    <h2 class="fw-bold p-3 text-decoration-underline"> EQUIPOS 2023</h2>
        <div class="w-100 mx-auto d-flex">
            <img src="../images/equipos/RB.jpg" class="w-50 p-3">
            <img src="../images/equipos/mercedes.jpg" class="w-50 p-3">
        </div>
        <div class="w-100 mx-auto d-flex">
            <img src="../images/equipos/Ferrari.jpg" class="w-50 p-3">
            <img src="../images/equipos/Mclaren.jpg" class="w-50 p-3">
        </div>
        <div class="w-100 mx-auto d-flex">
            <img src="../images/equipos/aston.jpg" class="w-50 p-3">
            <img src="../images/equipos/alpine.jpg" class="w-50 p-3">
        </div>
        <div class="w-100 mx-auto d-flex">
            <img src="../images/equipos/williams.jpg" class="w-50 p-3">
            <img src="../images/equipos/alpha.jpg" class="w-50 p-3">
        </div>
        <div class="w-100 mx-auto d-flex">
            <img src="../images/equipos/alfa.jpg" class="w-50 p-3">
            <img src="../images/equipos/haas.jpg" class="w-50 p-3">
        </div>
  </section>
