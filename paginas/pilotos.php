...
<html lang="en">
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link fw-bold" href="#">PILOTOS</a>
          </li>
          <li class="nav-item">
  ...
  <!--VIDEO PILOTOS-->
  <div class="mx-auto w-75 h-75 ratio ratio-16x9">
    <iframe width="560" height="315" src="https://www.youtube.com/embed/IqzcZP_sbqs?si=32XUix__1JzWezsx" class="p-3" title="YouTube video player" frameborder="0" 
    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
  </div>

  <!--PILOTOS DESCRIPCIONES-->

  <div class="accordion w-75 mx-auto p-3" id="accordionPanelsStayOpenExample">
    <!--PILOTO-->
    <div class="accordion-item p-3" style="background-color: gainsboro;">
      <h2 class="accordion-header">
        <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="true" aria-controls="panelsStayOpen-collapseOne">
          MAX VERSTAPPEN
        </button>
      </h2>
      <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse">
        <div class="accordion-body">
            <img src="../images/pilotos/max.jpg" class="p-3 ml-2" width="320" height="450">
          <p></p><strong>MAX VERSTAPPPEN</strong> es de nacionalidad Holandesa, nacido en Bélgica, actualmente Tricampeón del mundo de la Fórmula 1.
          Empezó su aventura en toro rosso en el 2015, desde entonces está consiguiendo un gran palmarés a sus 26 años de edad.
        </div>
      </div>
    </div>
    <!--PILOTO-->
    <div class="accordion-item p-3" style="background-color: gainsboro;">
      <h2 class="accordion-header">
        <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
          SERGIO "CHECO" PÉREZ
        </button>
      </h2>
      <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse">
        <div class="accordion-body">
            <img src="../images/pilotos/checo.jpg" class="p-3 ml-2" width="350" height="450">
          <p></p><strong>CHECO PÉREZ</strong>, nacido en México hace 33 años ha logrado varios podiums y grandes premios dentro de la Fórmula 1, incluyendo 
          algún que otro campeonato de constructores. destaca su defensa en la pista y su gran amabilidad y forma de ser, pertenece al equipo de Red Bull Racing desde el 2021.
        </div>
      </div>
    </div>
    ...
    <div class="accordion-item p-3" style="background-color: gainsboro;">
      <h2 class="accordion-header">
        <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
          CARLOS SAINZ
        </button>
      </h2>
      <div id="panelsStayOpen-collapseThree" class="accordion-collapse collapse">
        <div class="accordion-body">
            <img src="../images/pilotos/carlos.jpg" class="p-3 ml-2" width="350" height="450">
          <p></p>
          <strong>CARLOS SAINZ</strong> es uno de los españoles que tenemos en este gran deporte demostrando su habilidad con los coches, tal y como lo hace a día de hoy su padre Carlos Sainz.
          Empezó en 2015 con el equipo Toro Rosso y pasando por equipos como Ranault, Mclaren y actualmente Ferrari, ha dejado ya su nombre inscrito en la historia de la Fórmula 1. 
        </div>
      </div>
    </div>
    ...
    <div class="accordion-item p-3" style="background-color: gainsboro;">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseFour" aria-expanded="false" aria-controls="panelsStayOpen-collapseFour">
            CHARLES LECLERC
          </button>
        </h2>
        <div id="panelsStayOpen-collapseFour" class="accordion-collapse collapse">
          <div class="accordion-body">
            <img src="../images/pilotos/charles.png" class="p-3 ml-2" width="320" height="450">
          <p></p>
            <strong>CHARLES LECLERC </strong>,monegasco de 26 años, que pertenece al equipo Ferrari y que pasando por diferentes copas del mundo de karting, fórmula Ranault,
            Fórmula 2 y 3 llegó a la F1 en el año 2018 al equipo llamado Sauber y fichando en la temporada 2019 por Ferrari; equipo que le ha llevado a ganar varios premios.
    ...
    <!--PILOTO-->
      <div class="accordion-item p-3" style="background-color: gainsboro;">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseFive" aria-expanded="false" aria-controls="panelsStayOpen-collapseFive">
            LANDO NORRIS
          </button>
        </h2>
        <div id="panelsStayOpen-collapseFive" class="accordion-collapse collapse">
          <div class="accordion-body">
            <img src="../images/pilotos/lNDO.jpg" class="p-3 ml-2" width="350" height="450">
          <p></p>
            <strong>LANDO NORRIS </strong> es uno de los británicos que componen esta parrilla de pilotos, con 24 años y algún que otro 2º puesto en grandes premios, se deja mucho notar por la pista 
            desde su fichaje con el equipo Mclaren en 2019, equipo con el que a día de hoy siguen juntos. Llegó a ser subcampeón de la F2 en 2018.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item p-3" style="background-color: gainsboro;">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseSix" aria-expanded="false" aria-controls="panelsStayOpen-collapseSix">
            OSCAR PIASTRI
          </button>
        </h2>
        <div id="panelsStayOpen-collapseSix" class="accordion-collapse collapse">
          <div class="accordion-body">
            <img src="../images/pilotos/oscar.jpg" class="p-3 ml-2" width="350" height="450">
          <p></p>
            <strong>OSCAR PIASTRI</strong>, piloto nacido en Melbourne en 2001, es uno de los pilotos más jóvenes de la parrilla. Empezó en 2021 como piloto reserva de Alpine,
            pero después de 2 años sin asiento, en 2023 Mclaren lo fichó, equipo con el que ha conseguido sus primeros 87 puntos y 2 podiums.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item p-3" style="background-color: gainsboro;">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseSeven" aria-expanded="false" aria-controls="panelsStayOpen-collapseSeven">
            LEWIS HAMILTON
          </button>
        </h2>
        <div id="panelsStayOpen-collapseSeven" class="accordion-collapse collapse">
          <div class="accordion-body">
            <img src="../images/pilotos/lewis.jpg" class="p-3 ml-2" width="350" height="450">
          <p></p>
            <strong>LEWIS HAMILTON</strong> es uno de los peces gordos de esta parrilla, ya que con la edad de 38 años pertenece al equipo Mercedes, el cuál le ha acompañado dejando su nombre escrito en:
            7 Campeonatos del Mundo, 103 victorias. Empezó en 2007 con el equipo Mclaren  y siempre ha sido un gran ejemplo de admiración para este gran deporte.
        </div>
      </div>
      </div>
      ...
      <div class="accordion-item p-3" style="background-color: gainsboro;">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseEight" aria-expanded="false" aria-controls="panelsStayOpen-collapseEight">
            GEORGE RUSSELL
          </button>
        </h2>
        <div id="panelsStayOpen-collapseEight" class="accordion-collapse collapse">
          <div class="accordion-body">
            <img src="../images/pilotos/george.jpg" class="p-3 ml-2" width="350" height="450">
          <p></p>
            <strong>GEORGE RUSSELL</strong> es otro de los británicos junto a Lewis y Lando dentro de este conjunto. Tiene actualmente  25 años, ha ganado un campeonato del mundo de F2,
            el cuál le sirvió para estar en Williams desde 2019, en 2022 fichó por el equipo Mercedes aunque alguna vez había ya pilotado en este equipo sustituyendo a otros y dejando huella.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item p-3" style="background-color: gainsboro;">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseNine" aria-expanded="false" aria-controls="panelsStayOpen-collapseNine">
            YUKI TSUNODA
          </button>
        </h2>
        <div id="panelsStayOpen-collapseNine" class="accordion-collapse collapse">
          <div class="accordion-body">
            <img src="../images/pilotos/yuki.jpg" class="p-3 ml-2" width="520" height="430">
          <p></p>
            <strong>YUKI TSUNODA</strong> es un piloto de la escudería Alpha Tauri, conocida anteriormente como Toro Rosso. Yuki es el único Japonés en la F1 y con sus 23 años,
            ya ha logrado sus primeros puntos y ha corrido 65 carreras.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item p-3" style="background-color: gainsboro;">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTen" aria-expanded="false" aria-controls="panelsStayOpen-collapseTen">
            DANIEL RICCIARDO
          </button>
        </h2>
        <div id="panelsStayOpen-collapseTen" class="accordion-collapse collapse">
          <div class="accordion-body">
            <img src="../images/pilotos/daniel.jpg" class="p-3 ml-2" width="350" height="450">
          <p></p>
            <strong>DANIEL RICCIARDO</strong> es uno de los pilotos más queridos por la afición de este gran deporte. El australiano ha disputado 239 carreras de F1, logrando en su palmarés:
            8 victorias y 32 podiums entre otras. Comenzó en 2011 en el equipo Toro Rosso, y pasando por Red Bull, Renault y Mclaren, se encuentra ahora disputando estas carreras con Alpha Tauri.
          </div>
        </div>
      </div>
      <!--PILOTO-->
    <div class="accordion-item p-3" style="background-color: gainsboro;">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseEleven" aria-expanded="true" aria-controls="panelsStayOpen-collapseEleven">
            GUANYU ZHOU
          </button>
        </h2>
        <div id="panelsStayOpen-collapseEleven" class="accordion-collapse collapse">
          <div class="accordion-body">
            <img src="../images/pilotos/zhou.jpg" class="p-3 ml-2" width="440" height="420">
          <p></p>
            <strong>GUANYU ZHOU</strong> es el único piloto chino de este grupo. Empezando en la F1 en el año 2022 en la escudería de Alfa Romeo, nacido en el 1999;
            con sus 24 años ha disputado ya 43 grandes premios y ha protagonizado uno de los accidentes más impactantes de estos últimos años en este deporte.
          </div>
        </div>
      </div>
      <!--PILOTO-->
      <div class="accordion-item p-3" style="background-color: gainsboro;">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwelve" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwelve">
            VALTTERI BOTTAS
          </button>
        </h2>
        <div id="panelsStayOpen-collapseTwelve" class="accordion-collapse collapse">
          <div class="accordion-body">
            <img src="../images/pilotos/valtteri.jpg" class="p-3 ml-2" width="350" height="450">
            <p></p>
            <strong>VALTTERI BOTTAS</strong>  es un piloto de Finlandia con bastante experiencia ya que empezó en 2012 su camino en el equipo de Williams hasta el 2016, que fichó por el equipo Mercedes acompañando 
            a Lewis a ganar sus compeonatos. A sus 34 años compite para el equipo Alfa Romeo, después de ganar 10 carreras en la máxima categoría. 
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item p-3" style="background-color: gainsboro;">
        <h2 class="accordion-header">
          <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThirteen" aria-expanded="false" aria-controls="panelsStayOpen-collapseThirteen">
            PIERRE GASLY
          </button>
        </h2>
        <div id="panelsStayOpen-collapseThirteen" class="accordion-collapse collapse">
          <div class="accordion-body">
            <img src="../images/pilotos/gasly.jpg" class="p-3 ml-2" width="440" height="420">
          <p></p>
            <strong>PIERRE GASLY</strong>, piloto francés de 27 años que lleva desde el 2017 compitiendo en este deporte, pasando por Toro Rosso, hasta el 2019, ya que Redbull lo subió al equipo 
            y protagonizó un hecho que pocas veces se ve, ya que disputó 12 carreras y lo volvieron a dejar el Toro Rosso.
          </div>
        </div>
      </div>
      ...
      <div class="accordion-item p-3" style="background-color: gainsboro;">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseFourteen" aria-expanded="false" aria-controls="panelsStayOpen-collapseFourteen">
              ESTEBAN OCON
            </button>
          </h2>
          <div id="panelsStayOpen-collapseFourteen" class="accordion-collapse collapse">
            <div class="accordion-body">
                <img src="../images/pilotos/ocon.jpg" class="p-3 ml-2"width="450" height="420">
                <p></p>
              <strong>ESTABA OCON</strong> es un piloto nacido en Francia, que debutó en la máxima categoría con el equipo Manor y más tarde para Force India, Racing Point y después de un año estando como piloto de pruebas en mercedes,
              fichó por Renault que pasó a ser Alpine siendo compañero de Fernando Alonso, hasta el día de hoy que sigue con Alpine. Tiene 1 victoria en la F1.
      ...
      <!--PILOTO-->
        <div class="accordion-item p-3" style="background-color: gainsboro;">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseFifthteen" aria-expanded="false" aria-controls="panelsStayOpen-collapseFifthteen">
             FERNANDO ALONSO
            </button>
          </h2>
          <div id="panelsStayOpen-collapseFifthteen" class="accordion-collapse collapse">
            <div class="accordion-body">
                <img src="../images/pilotos/fernando.jpg" class="p-3 ml-2" width="350" height="450">
          <p></p>
              <strong>FERNANDO ALONSO</strong>, español, con una gran experiencia en la Fórmula 1, un gran ejemplo para muchos jóvenes pilotos que se inspiran en él, lleva compitiendo durante más de 15 años,
              debutando en Minardi, ganando el mundial en 2005 y 2006, ha logrado 32 victorias, 106 podios y a parte, victorias en la WEC,corriendo 3 veces La Indycar Series,  y llegando a ganar un rally dakar. Sigue compitiendo a sus 41 años en el equipo Aston Martin.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item p-3" style="background-color: gainsboro;">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseSixteen" aria-expanded="false" aria-controls="panelsStayOpen-collapseSixteen">
              LANCE STROLL
            </button>
          </h2>
          <div id="panelsStayOpen-collapseSixteen" class="accordion-collapse collapse">
            <div class="accordion-body">
                <img src="../images/pilotos/lance.jpg" class="p-3 ml-2" width="350" height="450">
          <p></p>
              <strong>LANCE STROLL</strong> es el canadiense que pertenece al equipo Aston Martin en la F1, ha disputado ya 144 carreras logrando 3 podios. Debutó en 2017 con Williams y pasando por Racing Point 
              llegó a este gran equipo. Protagonista ya que le acompaña su padre multimillonario a cada equipo que va, convirtiendose en un gran accionista de estos.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item p-3" style="background-color: gainsboro;">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseSeventeen" aria-expanded="false" aria-controls="panelsStayOpen-collapseSeventeen">
              ALEX ALBON
            </button>
          </h2>
          <div id="panelsStayOpen-collapseSeventeen" class="accordion-collapse collapse">
            <div class="accordion-body">
                <img src="../images/pilotos/alex.jpg" class="p-3 ml-2" width="350" height="450">
          <p></p>
              <strong>ALEX ALBON</strong>, piloto tailandés, que después de quedar 3º en el mundial de F2 en 2018, pasó al equipo Toro Rosso, quitándole el puesto a Pierre Gasly a mitad de temporada y entrando en RedBull en 2019, en el que estaría 
              hasta 2020. Compitió en el DTM en 2021 y en 2022 después de grandes acciones, volvió a la Fórmula 1 en el equipo Williams. 
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item p-3" style="background-color: gainsboro;">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseEightteen" aria-expanded="false" aria-controls="panelsStayOpen-collapseEightteen">
              LOGAN SARGEANT
            </button>
          </h2>
          <div id="panelsStayOpen-collapseEightteen" class="accordion-collapse collapse">
            <div class="accordion-body">
                <img src="../images/pilotos/logan.jpg" class="p-3 ml-2" width="350" height="450">
          <p></p>
              <strong>LOGAN SARGEANT</strong>, piloto de EEUU, el único de la parrilla. Fué la apuesta del equipo Williams en la temporada 2022, pese a no ganar el campeonato de F3 ni de F2, fue subido a la F1 por su potencial con la edad de 20 años.
              A día de hoy sigue con Williams con 22 años ya y ha sido el primer estadounidense desde el 1993 que consigue puntos en la F1.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item p-3" style="background-color: gainsboro;">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseNineteen" aria-expanded="false" aria-controls="panelsStayOpen-collapseNineteen">
              NIKO HULKENBERG
            </button>
          </h2>
          <div id="panelsStayOpen-collapseNineteen" class="accordion-collapse collapse">
            <div class="accordion-body">
                <img src="../images/pilotos/niko.jpg" class="p-3 ml-2" width="350" height="450">
          <p></p>
              <strong>NIKO HULKENBERG</strong>, piloto de origen alemán, con experiencia en la Fórmula 1 pero que a sus 36 años y 205 carreras, nunca ha logrado un podio. Debutó con el equipo Williams en 2007 pero hasta 2010 no tuvo su asiento asegurado, pasó por equipos como:
              Force India, Sauber, Renault, Racing Point, Aston Marting y por último, y actualmente, se encuentra en HAAS.
            </div>
          </div>
        </div>
        ...
        <div class="accordion-item p-3" style="background-color: gainsboro;">
          <h2 class="accordion-header">
            <button class="accordion-button collapsed bg-secondary" style="color:white;" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTuenty" aria-expanded="false" aria-controls="panelsStayOpen-collapseTuenty">
              KEVIN MAGNUSEN
            </button>
          </h2>
          <div id="panelsStayOpen-collapseTuenty" class="accordion-collapse collapse">
            <div class="accordion-body">
                <img src="../images/pilotos/kevin.jpg" class="p-3 ml-2" width="350" height="450">
          <p></p>
              <strong>KEVIN MAGNUSEN</strong>, danés de 31 años, con 1 podio y 163 carreras en esta gran categoría, disputa este año 2023 con el equipo estadounidense HAAS. Debutó en 2014 con el equipo Mclaren
              pasó a Renault en 2016 y estuvo en HAAS desde el 2017 hasta el 2020, volviendo a recuperar su asiento en 2022.
            </div>
          </div>
        </div>
  </div>
