...
<html lang="en">
  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center p-3" >
      <li class="page-item w-25">
        <a class="page-link text-center" href="#" style="color:rgb(247, 53, 53)">EQUIPOS</a>
      </li>
      <li class="page-item w-25">
        <a class="page-link text-center" href="cla_pilotos.php">PILOTOS</a>
      </li>
    </ul>
  </nav>
  ...
  <div class="container-fluid w-75">
    <h2 class="fw-bold text-decoration-underline p-3">CLASIFICACION 2023 EQUIPOS</h2>
