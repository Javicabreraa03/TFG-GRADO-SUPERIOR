    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active fw-bold" aria-current="page" href="#">CLASIFICACIÓN</a>
          </li>
          <li class="nav-item">
  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center p-3" >
      <li class="page-item w-25 ">
        <a class="page-link text-center" href="clasificacion.php" >EQUIPOS</a>
      </li>
      <li class="page-item w-25">
        <a class="page-link text-center" href="#" style="color:rgb(247, 53, 53)">PILOTOS</a>
      </li>
    </ul>
  </nav>
...
<div class="container-fluid w-75">
    <h2 class="fw-bold text-decoration-underline p-3">CLASIFICACIÓN 2023 PILOTOS</h2>
