...
if (isset($_COOKIE[$nombreCookie])) {
  echo '<script type="text/javascript">var textoActivo = "Borrar cookies";
   var URL = "borrar.php";
   alert("YA HAS VISITADO ANTES NUESTRA PÁGINA, SI DESEA BORRAR LAS COOKIES
   PULSE EL SIGUIENTE ENLACE." + console.log("textoActivo.link(URL));
   ...
   window.location.href="index.php"</script>';
    ...
    echo '<script type="text/javascript">alert("EN ESTA WEB USAMOS COOKIES. 
    ¿DESEA ACEPTARLAS? SI DESEA MÁS INFORMACIÓN SOBRE SU USO, EN EL PIÉ DE PÁGINA SE ENCUENTRA NUESTRA POLÍTICA DE COOKIES.");
...
<html lang="en">
    ...
    <nav class="navbar navbar-expand-lg bg-danger p-3" id="menu">
      <div class="container-fluid">
        <a class="navbar-brand" href="index.php">
          <span class="fw-bold">INICIO</span></a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="paginas\clasificacion.php">CLASIFICACIÓN</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="paginas\equipos.php">EQUIPOS</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="paginas\pilotos.php">PILOTOS</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="paginas\calendario.php">CALENDARIO</a>
            </li>
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li><a class="dropdown-item" href="paginas\registrar.php">REGISTRARSE</a></li>
            </ul>
          </li>
        </ul>
          <form class="d-flex" action="buscadorIndex.php" method="get" role="search">
  ...
  <div class="offcanvas offcanvas-end bg-danger" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
    ...
    <div class="offcanvas-body">
        <form class="needs-validation" action="login.php" method="post">
            ...
            <button type="submit" type="button" class="btn btn-dark mt-4 " name="btnEntrar">
                ENTRAR
            </button>
    ...
    <div id="carouselExampleCaptions" class="carousel slide bg-light" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="2000">
          <img src="images/carouselInicio/carousel1.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item"  data-bs-interval="2000">
          <img src="images/carouselInicio/carousel2.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item"  data-bs-interval="2000">
          <img src="images/carouselInicio/carousel3.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item"  data-bs-interval="2000">
          <img src="images/carouselInicio/carousel4.jpg" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item"  data-bs-interval="2000">
          <img src="images/carouselInicio/carousel5.jpg" class="d-block w-100" alt="...">
        </div>
      </div>
      <button class="carousel-control-prev" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="prev">
        <span class="carousel-control-prev-icon" aria-hidden="true"></span>
        <span class="visually-visible text-dark">Anterior</span>
      </button>
      <button class="carousel-control-next" type="button" data-bs-target="#carouselExampleCaptions" data-bs-slide="next">
        <span class="carousel-control-next-icon" aria-hidden="true"></span>
        <span class="visually-visible text-dark">Siguiente</span>
      </button>
    </div>

    <!--CONTENEDOR DE INFO-->
    <section class="w-75 mx-auto text-center pt-3 shadow p-3 mb-5 mt-4 bg-body-tertiary rounded" id="intro">
      <h1 class="p-3 fs-2 border-top border-3">Tu blog favorito de <span class="text-danger fw-bold">Fórmula 1</span></h1>
      <p class="p-3 fs-5"><span class="text-danger fw-bold">Tu Fórmula 1</span> es el blog donde podrás encontrar toda
      la información deseada sobre la Fórmula 1 en la actualidad, así pues comentar en el foro, consultar 
      la clasificación, estar al día con las noticias y descubrir cada curiosidad de este deporte al máximo</p>
      </section>

      <!--SECCIÓN DE NOTICIAS-->
    <section class="container fluid">
      <h2 class="w-75 p-3 fs-3" id="noticias">NOTICIAS</h2>
        <div class="row w-100 mx-auto">
          <div class="col-lg-6 col-md-12 col-sm-12 p-4" id="noticia">
            <img src="images/noticias/contratos.jpg" alt="nuevos_pilotos" width="400" height="270">
            <div>
              <h3 class="fs-5 mt-4 px-4 pb-1" id="noticias">DURACIÓN DE CONTRATOS</h3>
              <p class="px-4">Aquí tenemos la duración de los contratos
                sabiendo que, este será el "line-up" de pilotos y equipos en 2024
              </p>
            </div>
          </div>

          <div class="col-lg-6 col-md-12 col-sm-12 shadow p-4 mb-5 bg-body-tertiary rounded" id="noticia">
            <img src="images/noticias/podium.jpg" alt="pilotos_podium" width="280" height="270">
            <div>
              <h3 class="fs-5 mt-4 px-4 pb-1" id="noticias">PILOTOS AL PODIUM</h3>
              <p class="px-4">Estos son los 11 pilotos, a falta de 2 carreras,
                que han logrado subir al podium en esta temporada 2023
              </p>
            </div>
          </div>

          <div class="col-lg-6 col-md-12 col-sm-12 shadow p-4 mb-5 bg-body-tertiary rounded" id="noticia">
            <img src="images/noticias/verstappen.jpg" alt="verstappen" width="280" height="270">
            <div>
              <h3 class="fs-5 mt-4 px-4 pb-1" id="noticias">¡CAMPEÓN DEL MUNDO!</h3>
              <p class="px-4">Max Verstappen se ha proclamado por tercera vez campeón 
                del mundo de la F1, lo consiguió en la Sprint Race del #QATARGP
              </p>
            </div>
          </div>

          <div class="col-lg-6 col-md-12 col-sm-12 p-4"id="noticia">
            <img src="images/noticias/vegasgp.jpg" alt="lasvegasgp" width="350" height="270" >
            <div>
              <h3 class="fs-5 mt-4 px-4 pb-1" id="noticias">GP DE LAS VEGAS</h3>
              <p class="px-4">Nuevo gran premio que se estrena este año en el calendario,
                un nuevo circuito urbano en el que los pilotos correran de noche
              </p>
            </div>
          </div>
        </div>
 ...
 <!--INFO-->
    <h2 class="container fluid w-100 p-3" id="info">INFO</h2>
     <section class="container-fluid" style="height: 950px;" id="fotoinfo">
       <div class="w-75 mx-auto p-3">
         <h2 class="text-center" id="tituloinfo">PRÓXIMO CIRCUITO 17/11/2023-19/11/2023</h2>
         <img src="images/info/las_vegas.jpg" class="w-100 mb-2 shadow-lg p-3 mb-5 bg-body-tertiary rounded" id="fotoGrande">    
       </div>
    </section>
  <!--INFO ANTERIOR GP-->
      <div class="card-group container-fluid p-5" style="margin-top: 50px;" id="cartas">
        <div class="card">
           <img src="images/info/circuito_interlagos.jpg" class="card-img-top mx-auto w-100 h-50 shadow-lg p-3 mb-3 bg-body-tertiary rounded" alt="lasvegasgp" id="foto">
           <div class="card-body text-center p-3">
             <h5 class="card-title">CIRCUITO ANTERIOR</h5>
             <p class="card-text">CIRCUITO DE INTERLAGOS, BRASIL, HISTÓRICO CIRCUITO DONDE SE HAN PROCLAMADO VARIOS PILOTOS CAMPEONES DEL MUNDO.</p>
           </div>
         </div>
         <div class="card">
           <img src="images/info/qualy.jpg" class="card-img-top mx-auto w-75 h-75 shadow-lg p-3 mb-3 bg-body-tertiary rounded" alt="qualybra" id="foto">
           <div class="card-body text-center p-3">
             <h5 class="card-title">PARRILLA DE SALIDA</h5>
             <p class="card-text">TOP 10 DE LA PARRILLA DE SALIDA DEL GRAN PREMIO DE BRASIL</p>
           </div>
         </div>
         <div class="card">
           <img src="images/info/top10brasil.jpg" class="card-img-top mx-auto w-75 h-75 shadow-lg p-3 mb-3 bg-body-tertiary rounded" alt="top10bra" id="foto">
           <div class="card-body text-center p-3">
             <h5 class="card-title">GP BRASIL TOP 10</h5>
             <p class="card-text">LOS 10 PRIMEROS PILOTOS QUE CRUZARON LA META DESPUÉS DE TERMINAR SUS VUELTAS EN EL CIRCUITO DE INTERLAGOS</p>
           </div>
         </div>
       </div>
...
<div class="modal fade" id="exampleModal4" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content w-100">
      ...
      <div class="modal-footer"> 
        <button type="button" class="btn btn-secondary fw-bold mt-4" data-bs-dismiss="modal">CERRAR</button>
        <button type="button" class="btn btn-danger fw-bold mt-4" data-bs-dismiss="modal">ACEPTAR</button>
      </div> 
    </form>
    </div>
  </div>
            ...
            <ul class="col-3 list-unstyled p-4 my-auto" id="logos">
              ...
              <li>
                ...
                <a href="https://www.tiktok.com/@f1" class="text-reset">
                  <img src="images\footer\tiktok.jpg" width="50"height="50" alt="tiktok logo">
                </a>
                <a href="https://twitter.com/f1" class="text-reset"> 
                  <img src="images\footer\tw.jpg" width="50"height="50" alt="tw logo">
                </a>
